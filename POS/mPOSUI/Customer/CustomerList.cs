...
namespace POS
{
    public partial class CustomerList : Form
    {
        ...
        public void DataBind()
        {
            ...
            dgvCustomerList.DataSource = (from c in entity.Customers where c.CustomerTypeId == 1 select c).ToList();
        }
        ...
        private void dgvCustomerList_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                {
                    CustomerOffsetfrm offserFrm = new CustomerOffsetfrm();
                    offserFrm.customerID= Convert.ToInt32(dgvCustomerList.Rows[e.RowIndex].Cells[0].Value);
                    offserFrm.ShowDialog();
                }
                //Edit this User
