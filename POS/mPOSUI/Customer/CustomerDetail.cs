...
namespace POS
{
    public partial class CustomerDetail : Form
    {
        ...
        public void LoadData()
        {
            ...
            {
                totalPrepaid += Convert.ToInt32(row.Cells[4].Value);                
            }
            lblPayableAmt.Text = (TotalOutstanding - totalPrepaid).ToString();
        }
        ...
        private void btnPaidTransaction_Click(object sender, EventArgs e)
        {
           ...
           // Boolean IsError = false;
            ...
            if (dgvOutstandingTransaction.Rows.Count >= 0){
                ...
                form.IsPaidByTrans = true;
                long totaloutstanding = 0;
                long.TryParse(lblPayableAmt.Text, out totaloutstanding);
        ...
        private void dgvPrePaid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (e.ColumnIndex == 5)
                {
                    string v = e.ColumnIndex.ToString();
                }
            }
