            ...
            if (e.RowIndex >= 0)
            {
                ...
                else if (e.ColumnIndex == 10)
                {
                    ...
                    else
                    {
                        ...
                        var isPackageUsed = entity.PackageUsedHistories.Any(x => x.PackagePurchasedInvoice.TransactionDetail.TransactionId == currentTransactionId);
                        ...
                        {
                            MessageBox.Show("This transaction already Used Package Qty. It cannot be deleted!");
                        }
