           ...
           if (patientID != 0)
            {
                var data = (from d in entity.PackageUsedHistories
                            ...
                            (d.PackagePurchasedInvoice.CustomerId == patientID)
                            && d.IsDelete == false
                            select new
                            {
                                UseQty = d.UseQty,
                                CustomerName = d.PackagePurchasedInvoice.Customer.Name,
                ...
                if (data.Count > 0)
                {
                    ...
                    foreach (var item in data)
                    {
                        ...
                        customeroffset.TransactionDate = item.TransactionDate.Date;
                        ...
                        customeroffset.UsedDate = item.UsedDate.Date;
