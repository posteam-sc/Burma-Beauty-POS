...
namespace POS.APP_Data
{
    ...
    public partial class POSEntities : DbContext
    {
        ...
        public DbSet<PackagePurchasedInvoice> PackagePurchasedInvoices { get; set; }
        public DbSet<PackageUsedHistory> PackageUsedHistories { get; set; }
        ...
        public virtual ObjectResult<Nullable<int>> InsertTicket(Nullable<long> transactionDetailId, Nullable<bool> status, Nullable<System.DateTime> createDate, string category, string shopCode)
        {
            var transactionDetailIdParameter = transactionDetailId.HasValue ?
                new ObjectParameter("transactionDetailId", transactionDetailId) :
                new ObjectParameter("transactionDetailId", typeof(long));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("InsertTicket", transactionDetailIdParameter, statusParameter, createDateParameter, categoryParameter, shopCodeParameter);
        }
        ...
        public virtual ObjectResult<StockTransactionReport_Result> StockTransactionReport(Nullable<int> year, Nullable<int> month)
        {
            var yearParameter = year.HasValue ?
                new ObjectParameter("Year", year) :
                new ObjectParameter("Year", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<StockTransactionReport_Result>("StockTransactionReport", yearParameter, monthParameter);
        }
        ...
        public virtual int VIPReportForNoveltyAndGWP(Nullable<int> customerType, Nullable<System.DateTime> fromDate, Nullable<System.DateTime> toDate, Nullable<int> counterId, Nullable<int> cityId)
        {
            var customerTypeParameter = customerType.HasValue ?
                new ObjectParameter("customerType", customerType) :
                new ObjectParameter("customerType", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("VIPReportForNoveltyAndGWP", customerTypeParameter, fromDateParameter, toDateParameter, counterIdParameter, cityIdParameter);
        }
    
        public virtual ObjectResult<string> InsertTransaction(Nullable<System.DateTime> dateTime, Nullable<int> userId, Nullable<int> counterId, string type, Nullable<bool> isPaid, Nullable<bool> isActive, Nullable<int> paymentTypeId, Nullable<int> taxAmount, Nullable<int> discountAmount, Nullable<long> totalAmount, Nullable<long> recieveAmount, Nullable<int> giftCardId, Nullable<int> customerId, Nullable<decimal> mCDiscountAmt, Nullable<decimal> bDDiscountAmt, Nullable<int> memberTypeId, Nullable<decimal> mCDiscountPercent, Nullable<bool> isSettlement, string tranVouNos, Nullable<bool> isWholeSale, Nullable<decimal> giftCardAmt, Nullable<int> shopId, string shopCode, string note, Nullable<int> tableid, Nullable<int> servicefee, string transactionParentId, Nullable<bool> isDeleted, Nullable<int> receivedCurrencyId)
        {
            var dateTimeParameter = dateTime.HasValue ?
                new ObjectParameter("DateTime", dateTime) :
                new ObjectParameter("DateTime", typeof(System.DateTime));
